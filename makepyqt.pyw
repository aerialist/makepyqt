...
class OptionsForm(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        pyuic5Button.clicked.connect(
                lambda: self.setPath("pyuic5"))
        pyrcc5Button.clicked.connect(
                lambda: self.setPath("pyrcc5"))
        pylupdate5Button.clicked.connect(
                lambda: self.setPath("pylupdate5"))
        lreleaseButton.clicked.connect(
...
if sys.platform.startswith("darwin"):
    ...
    if i > -1:
        PYUIC5 = PYUIC5[:i] + "Lib/python3.5/site-packages/PyQt5/uic/pyuic.py"
